...
(
    region_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    med_organization_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1)PRIMARY KEY,
...
(
    type_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    area_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    qualification_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    gender_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    specialty_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    patient_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    profile_working_hours_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    hospital_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    doctor_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
(
    talon_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
    delete_dt date,
...
(
    jornal_id number GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
